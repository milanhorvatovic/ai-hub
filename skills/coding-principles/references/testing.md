...
- **Property-based testing** — generate inputs, assert invariants; the framework shrinks failures to minimal repros. For parsing, encoding, math, normalization. (hypothesis / fast-check / proptest — see capabilities.)
