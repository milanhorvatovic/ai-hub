...
Concrete before/after code for high-leverage principles 5, 16, 19 and mantra 11 lives in `references/examples.md`. Load it when matching patterns at write-time or validating suggested fixes at review-time.
