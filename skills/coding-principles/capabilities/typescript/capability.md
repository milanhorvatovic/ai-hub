...
Concrete before/after code for high-leverage principles (16, 18, 19) lives in `examples.md` (sibling). Load it when matching patterns at write-time or validating suggested fixes at review-time.
