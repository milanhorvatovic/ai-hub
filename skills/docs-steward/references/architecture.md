...
6. Decide whether a bundled fallback config is shippable — if yes, drop the file in beside the other bundled configs (its sibling `README.md` covers scope + rationale) and wire it into `bundled_config.py`.
