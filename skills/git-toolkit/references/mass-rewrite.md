...
- The diff `git diff pre-rewrite/<branch> <branch>` — should show only message changes, never tree changes. Any tree-content diff indicates the filter tool mis-applied.
