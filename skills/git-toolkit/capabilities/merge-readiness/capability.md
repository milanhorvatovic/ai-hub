...
- If `author.login` matches a pattern in `../../references/bot-signatures.md` → mention but proceed (bots merge bot PRs through their own logic; merge-readiness is informational for bot PRs).
