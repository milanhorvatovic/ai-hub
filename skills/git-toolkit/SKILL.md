...
description: >
  ...
  inconsistent. Works on GitLab and Codeberg/Forgejo too. Never
...
|---|---|---|---|---|
| pr-description | full | full | full | refuses |
